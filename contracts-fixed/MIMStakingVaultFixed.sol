...
/**
 * @title MIMStakingVault (sMIM) - FIXED VERSION
 ...
 */
contract MIMStakingVaultFixed is ERC20, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MULTIPLIER = 0.12e18;
    uint256 public constant JUMP_MULTIPLIER = 1.00e18;
    uint256 public constant KINK = 0.80e18;
    uint256 public constant MAX_UTILIZATION = 0.90e18;
     ...
     * @dev This is the actual MIM balance, not including accrued unpaid interest
    ...
    function maxWithdrawableShares(address user) public view returns (uint256) {
        ...
        // Maximum shares that can be redeemed with current cash
