 ...
 */
contract MIMTokenFixed is ERC20, Ownable {
    ...
    /**
     * @notice Burn MIM tokens from an address (requires minter role)
    ...
    /**
     * @notice Burn MIM tokens from sender with allowance check
     * @param _from Address to burn from
     * @param _amount Amount to burn
     */
