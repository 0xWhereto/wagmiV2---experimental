...
async function main() {
  ...
  console.log("\n=== Token Balances ===");
  console.log("sWETH:", ethers.utils.formatUnits(sWETHBalance, 18));
  console.log("sUSDC:", ethers.utils.formatUnits(sUSDCBalance, 6));
  console.log("sUSDT:", ethers.utils.formatUnits(sUSDTBalance, 6));
  ...
  async function createAndFundWethUsdcPool() {
    ...
    console.log("\n=== Adding Liquidity ===");
    console.log("sWETH available:", ethers.utils.formatUnits(currentSWETH, 18));
    console.log("sUSDC available:", ethers.utils.formatUnits(currentSUSDC, 6));
    ...
    if (sWETHAllowance < currentSWETH) {
      const approveTx1 = await sWETHContract.approve(POSITION_MANAGER, ethers.constants.MaxUint256);
    ...
    if (sUSDCAllowance < currentSUSDC) {
      const approveTx2 = await sUSDCContract.approve(POSITION_MANAGER, ethers.constants.MaxUint256);
    ...
    try {
      ...
      console.log("\nNew balances:");
      console.log("sWETH:", ethers.utils.formatUnits(newSWETH, 18));
      console.log("sUSDC:", ethers.utils.formatUnits(newSUSDC, 6));
      console.log("sWETH used:", ethers.utils.formatUnits(currentSWETH - newSWETH, 18));
      console.log("sUSDC used:", ethers.utils.formatUnits(currentSUSDC - newSUSDC, 6));
